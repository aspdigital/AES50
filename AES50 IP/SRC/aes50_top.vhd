...
entity aes50_top is
    port (
        ...
        --clk and reset from PLL
        clk50_i  : in std_logic;        -- from PLL, for ethernet
        clk100_i : in std_logic;        -- from PLL, main logic clock
        rst_i    : in std_logic;        -- logic reset in 100 MHz domain
        ...
        --connection to phy
        rmii_crs_dv_i : in  std_logic;  -- RMII RXD are valid
        rmii_rxd_i    : in  std_logic_vector(1 downto 0);  -- from PHY
        rmii_tx_en_o  : out std_logic;  -- RMII TXD are valid
        rmii_txd_o    : out std_logic_vector(1 downto 0);  -- to PHY
        phy_rst_n_o   : out std_logic;  -- PHY reset
        ...
        clk_1024xfs_from_pll_i : in  std_logic;  -- audio MCLK
        pll_lock_n_i           : in  std_logic;  -- PLL output is good
        clk_to_pll_o           : out std_logic;  -- PLL reference clock
        pll_mult_value_o       : out integer;  -- to CS2100 config, PLL multiploer
        pll_init_busy_i        : in  std_logic;  -- PLL busy initializing
